...
public class LlmProviderController {
    ...
    @Operation(summary = "创建 AI Provider 配置")
    @RequirePermission(
    ...
    @Operation(summary = "分页查询 AI Provider 配置")
    @RequirePermission(
    ...
    @Operation(summary = "查询 AI Provider 配置详情")
    @RequirePermission(
    ...
    @Operation(summary = "更新 AI Provider 配置（CAS 乐观锁）")
    @RequirePermission(
    ...
    @Operation(summary = "启停 AI Provider（CAS 乐观锁）")
    @RequirePermission(
    ...
    @Operation(summary = "逻辑删除 AI Provider 配置（CAS 乐观锁）")
    @RequirePermission(
    ...
    @Operation(summary = "测试 Chat Provider 连接")
    @RequirePermission(
